...
Реализовано. Пользовательское продолжение ограничено подготовительными LLM-этапами
без применения изменений, проверок и tool calls; перед повтором сверяется снимок
проекта и lifecycle. Для остальных этапов автоматический replay не разрешён.
